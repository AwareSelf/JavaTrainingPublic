...
public class Employee {
	...
	//to count no of objects of emp created you need shared class level variable
	// and not an instance variable so use static
	...
	*/
	...
	//some method that returns object type
