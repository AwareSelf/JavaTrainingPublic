...
public class ClassesObjectsApp {
	...
	public static void main(String[] args) {
		...
		Employee e=null; //e is reference of type Employee - object reference
		 ...
		 System.out.println("before creating single emp object:"+Employee.getCount());
		
		e = new Employee(1,"Anubhav Sinha",15000,10);
		 
       System.out.println("after creating emp objects: no of emp objs"+Employee.getCount());
		...
		*/
		...
		// System.out.println(e1.calcAnnSal());
			...
			System.out.println("after creating emp objects: no of emp objs"+Employee.getCount());
			System.out.println("after creating emp objects: no of emp objs:"+e3.getCount());
			e3.display();
			annsal = e3.calcAnnSal(5000);
			 ...
			 System.out.println("after creating emp objects: no of emp objs:"+e4.getCount());
			 e4.display();
