...
public class Employee implements Comparable<Employee> {
	...
	//e1 (empid=3)(prev).compareTo(e2 (empid=2)(next));
	@Override
	public int compareTo(Employee e) //e=e2
	{
		System.out.println("compareTo: emp with empid:"+this.empid+" compared with:"+e.empid);
		return this.empid - e.empid; //3-2=1 +ve value swap two elements //-ve value means no swap
		
		//return e.empid - this.empid;    //descending order of empid
	}
