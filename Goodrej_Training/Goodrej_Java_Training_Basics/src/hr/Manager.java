...
public class Manager extends Emp {
	...
	public Manager(int empid,String name,double salary,int deptno,String typeMgr,
			double commission,int teamSize,String role)
	{
	...
	{
		//protected is accessible to derived class (in same or another pkg)
		//protected role and getRole is also accessible from apppkg.Manager also
